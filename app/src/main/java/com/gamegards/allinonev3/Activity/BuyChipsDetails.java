    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        imgPaynow.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(SharePref.getInstance().getBoolean(SharePref.isPaymentGateShow))
                {
                    place_order();
                }
                else {
                    ...
                    Toast.makeText(BuyChipsDetails.this, ""+whats_no, Toast.LENGTH_SHORT).show();

                    if (!whats_no.equals(""))
                        Funtions.openWhatsappContact(BuyChipsDetails.this,county_code+whats_no);
                }
...
//
    ...
    public void startPayment( String ticket_id, String total_Amount, String razorPay_ID) {
        ...
        if(Funtions.checkisStringValid(key))
        {
            co.setKeyID(key);
        }
