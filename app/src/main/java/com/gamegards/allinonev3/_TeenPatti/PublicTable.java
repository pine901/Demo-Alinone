...
//        long numberamount = Float.parseFloat(wallet);
        float numberamount = 0;
        if(Funtions.checkStringisValid(wallet))
        {
            numberamount = Float.parseFloat(wallet);
        }
...
//            txtPlay1wallet.setText("" + numberamount);
...
//            txtPlay2wallet.setText("" + numberamount);
...
//            txtPlay3wallet.setText("" +numberamount);
...
//            txtPlay4wallet.setText("" +numberamount);
...
//            txtPlay5wallet.setText("" + numberamount);
...
//                                    long numberamount = Float.parseFloat(walletplayer1);
                                    float numberamount = 0;
                                    if (Funtions.checkStringisValid(walletplayer1)) {
                                        numberamount = Float.parseFloat(walletplayer1);
                                    }
...
//                                    txtPlay1wallet.setText("" + numberamount);
                                    ...
                                    Picasso.with(PublicTable.this).load(Const.IMGAE_PATH + profile_pic).into(imgpl1circle);
...
//first player
                                    ...
                                    if (user_id_player2.equals("0")) {
                                        ...
                                        String uri2 = "@drawable/ic_add_user_plus";  // where myresource
                                        // " +
...
//                                        long numberamount = Float.parseFloat(walletplayer2);

                                        float numberamount = 0;
                                        if (Funtions.checkStringisValid(walletplayer2)) {
                                            numberamount = Float.parseFloat(walletplayer2);
                                        }
...
//                                        txtPlay2wallet.setText("" + numberamount);
                                        ...
                                        Picasso.with(PublicTable.this).load(Const.IMGAE_PATH + profile_pic1).into(imgpl2circle);
...
//second player
                                    ...
                                    if (user_id_player3.equals("0")) {
                                        ...
                                        String uri3 = "@drawable/ic_add_user_plus";  // where myresource " +
...
//                                        long numberamount = Float.parseFloat(walletplayer3);

                                        float numberamount = 0;
                                        if (Funtions.checkStringisValid(walletplayer3)) {
                                            numberamount = Float.parseFloat(walletplayer3);
                                        }
...
//                                        txtPlay3wallet.setText("" + numberamount);
                                        ...
                                        Picasso.with(PublicTable.this).load(Const.IMGAE_PATH + profile_pic3).into(imgpl3circle);
...
//third player
                                    ...
                                    if (user_id_player4.equals("0")) {
                                        ...
                                        String uri4 = "@drawable/ic_add_user_plus";  // where myresource " +
...
//                                        long numberamount = Float.parseFloat(walletplayer4);
                                        float numberamount = 0;
                                        if (Funtions.checkStringisValid(walletplayer4)) {
                                            numberamount = Float.parseFloat(walletplayer4);
                                        }
//                                        txtPlay4wallet.setText("" + NumberFormat.getNumberInstance(Locale.US).format(numberamount));
//                                        txtPlay4wallet.setText("" + numberamount);

                                          txtPlay4wallet.setText("" + walletplayer4);
                                        Picasso.with(PublicTable.this).load(Const.IMGAE_PATH + profile_pic4).into(imgpl4circle);
                                    ...
                                    if (walletplayer5.equals("0")) {
                                        ...
                                        String uri5 = "@drawable/ic_add_user_plus";  // where myresource " +
...
//                                        long numberamount = Float.parseFloat(walletplayer5);
                                        float numberamount = 0;
                                        if (Funtions.checkStringisValid(walletplayer5)) {
                                            numberamount = Float.parseFloat(walletplayer5);
                                        }
//                                        txtPlay5wallet.setText("" + NumberFormat.getNumberInstance(Locale.US).format(numberamount));
//                                        txtPlay5wallet.setText("" + numberamount);

                                         txtPlay5wallet.setText("" + walletplayer5);
                                        Picasso.with(PublicTable.this).load(Const.IMGAE_PATH + profile_pic5).into(imgpl5circle);
...
//        Toast.makeText(context, ""+total_cards, Toast.LENGTH_SHORT).show();
    ...
    public void makeleavetable() {
        ...
        Picasso.with(PublicTable.this).load(imageResource).into(imgpl1circle);
        Picasso.with(PublicTable.this).load(imageResource).into(imgpl2circle);
        Picasso.with(PublicTable.this).load(imageResource).into(imgpl3circle);
        Picasso.with(PublicTable.this).load(imageResource).into(imgpl4circle);
        Picasso.with(PublicTable.this).load(imageResource).into(imgpl5circle);
