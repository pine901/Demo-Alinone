...
public class PublicTable_New extends AppCompatActivity {
        ...
        imgpl1show.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (playercount > 2) {
                    ...
                    //Toast.makeText(PublicTable_New.this, "Side Show Coming Soon.", Toast.LENGTH_LONG).show();
...
//                showDialogSetting();
    ...
    public void animationtask() {
        ...
        animMove1 = AnimationUtils.loadAnimation(PublicTable_New.this,
...
///                lnrcardsmainplayer1.setVisibility(View.VISloIBLE);
//                imgplayermain1.startAnimation(animMoveCardsPlayer1);
        ...
        animMove2 = AnimationUtils.loadAnimation(PublicTable_New.this,
...
//                imgplayer2mainfirst.startAnimation(animMoveCardsPlayer2);
        ...
        animMove3 = AnimationUtils.loadAnimation(PublicTable_New.this,
...
//                imgplayer3mainfirst.startAnimation(animMoveCardsPlayer3);
        ...
        animMove4 = AnimationUtils.loadAnimation(PublicTable_New.this,
...
//                imgplayer4mainfirst.startAnimation(animMoveCardsPlayer4);
        ...
        animMove5 = AnimationUtils.loadAnimation(PublicTable_New.this,
...
//                imgplayer5mainfirst.startAnimation(animMoveCardsPlayer5);
        ...
        animMove1_2 = AnimationUtils.loadAnimation(PublicTable_New.this,
                R.anim.movetodowntoup);
        ...
        animMove2_2 = AnimationUtils.loadAnimation(PublicTable_New.this,
                R.anim.movetodowntoup_corner);
        ...
        animMove3_2 = AnimationUtils.loadAnimation(PublicTable_New.this,
                R.anim.movetolefttoright);
        ...
        animMove4_2 = AnimationUtils.loadAnimation(PublicTable_New.this,
                R.anim.movetorighttoleft);
        ...
        animMove5_2 = AnimationUtils.loadAnimation(PublicTable_New.this,
                R.anim.movetodowntoup_corner_right_left);
        ...
        animMoveCardsPlayer1 = AnimationUtils.loadAnimation(PublicTable_New.this,
        ...
        animMoveCardsPlayer1.setAnimationListener(new Animation.AnimationListener() {
            ...
            public void onAnimationEnd(Animation animation) {
                ...
                Funtions.LOGE(TAG,"card1_count : "+card1_count+" total_cards : "+total_cards);
        ...
        animMoveCardsPlayer2 = AnimationUtils.loadAnimation(PublicTable_New.this,
        ...
        animMoveCardsPlayer2.setAnimationListener(new Animation.AnimationListener() {
            ...
            public void onAnimationEnd(Animation animation) {
                ...
                Funtions.LOGE(TAG,"card2_count : "+card2_count+" total_cards : "+total_cards);
        ...
        animMoveCardsPlayer3 = AnimationUtils.loadAnimation(PublicTable_New.this,
        ...
        animMoveCardsPlayer3.setAnimationListener(new Animation.AnimationListener() {
            ...
            public void onAnimationEnd(Animation animation) {
                ...
                Funtions.LOGE(TAG,"card3_count : "+card3_count+" total_cards : "+total_cards);
        ...
        animMoveCardsPlayer4 = AnimationUtils.loadAnimation(PublicTable_New.this,
        ...
        animMoveCardsPlayer4.setAnimationListener(new Animation.AnimationListener() {
            ...
            public void onAnimationEnd(Animation animation) {
                ...
                Funtions.LOGE(TAG,"card4_count : "+card4_count+" total_cards : "+total_cards);
        ...
        animMoveCardsPlayer5 = AnimationUtils.loadAnimation(PublicTable_New.this,
        ...
        animMoveCardsPlayer5.setAnimationListener(new Animation.AnimationListener() {
            ...
            public void onAnimationEnd(Animation animation) {
                ...
                Funtions.LOGE(TAG,"card5_count : "+card5_count+" total_cards : "+total_cards);
        ...
        animAmpireblink = AnimationUtils.loadAnimation(PublicTable_New.this,
                R.anim.blink);


        animMoveCardsPlayerwinner1 = AnimationUtils.loadAnimation(PublicTable_New.this,
                R.anim.movetoanotherwinner);
        animMoveCardsPlayerwinner2 = AnimationUtils.loadAnimation(PublicTable_New.this,
                R.anim.movetoanotherleftcornerwinner);

        animMoveCardsreferycomi = AnimationUtils.loadAnimation(PublicTable_New.this,
        ...
        animMoveCardsPlayerwinner3 = AnimationUtils.loadAnimation(PublicTable_New.this,
                R.anim.movetorighttoleftcardswinner);

        animMoveCardsPlayerwinner4 = AnimationUtils.loadAnimation(PublicTable_New.this,
                R.anim.movetolefttorightcardnewwinner);

        animMoveCardsPlayerwinner5 = AnimationUtils.loadAnimation(PublicTable_New.this,
        ...
        switchd.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton compoundButton, boolean isChecked) {
                if (isChecked) {
                    ...
                    // Toast.makeText(PublicTable_New.this, "On", Toast.LENGTH_LONG).show();

                } else {
                    // Toast.makeText(PublicTable_New.this, "Off", Toast.LENGTH_LONG).show();
                    SharedPreferences.Editor editor = getSharedPreferences(MY_PREFS_NAME, MODE_PRIVATE).edit();
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST, url,
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        ...
                        Funtions.LOGE("PublicTable_New",""+url+"\n"+response);
        ...
        try {
            ...
            if (code.equalsIgnoreCase("200")) {
                ...
                if (jsonObject.has("table_data")) {
                    ...
                    //  String message = jsonObject.getString("message");
//                        Toast.makeText(PublicTable_New.this, message,
//                                Toast.LENGTH_LONG).show();
                    //  }
                ...
                Toast.makeText(PublicTable_New.this, message, Toast.LENGTH_LONG).show();
                GameLeave("0");
    ...
    private void GameLeave(final String value) {
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST, Const.GAME_TABLE_LEAVE,
            ...
            public void onErrorResponse(VolleyError error) {
                progressDialog.dismiss();
                // Toast.makeText(PublicTable_New.this, "Something went wrong", Toast.LENGTH_LONG)
                // .show();
            }
        }) {
            @Override
                            ...
                            for (int k = 0; k < jsonArrayuser.length(); k++) {
                                if (k == 0) {
                                    ...
                                    if (user_id_player1.equals(prefs.getString("user_id", ""))) {
                                        ...
                                        Toast.makeText(PublicTable_New.this, "Your are timeout from " +
                    ...
                    public void onResponse(String response) {
                        ...
                        try {
                            ...
                            if (code.equals("200")) {
                                ...
                                // Toast.makeText(PublicTable_New.this, message, Toast.LENGTH_LONG)
                                // .show();
                    ...
                    public void onResponse(String response) {
                        ...
                        try {
                            ...
                            if (code.equalsIgnoreCase("200")) {
                                ...
                                if (jsonObject.has("message")) {
                                    String message = jsonObject.getString("message");
                                    //Toast.makeText(PublicTable_New.this, message, Toast
                                    // .LENGTH_LONG).show();
                                }
                        ...
                        try {
                            ...
                            if (code.equalsIgnoreCase("200")) {
                                ...
                                if (jsonObject.has("cards")) {
                                    ...
                                    if (jsonObject.has("message")) {
                                        String message = jsonObject.getString("message");
//                                        Toast.makeText(PublicTable_New.this, "Wrong mobile number or password",
//                                                Toast.LENGTH_LONG).show();
                                    }
...
//                }
    ...
    private void Parse_Response(String resp,String playerno,String gifturl) throws JSONException {
        ...
        if (code.equalsIgnoreCase("200")) {
            ...
            // Toast.makeText(PublicTable_New.this, ""+message, Toast.LENGTH_SHORT).show();
