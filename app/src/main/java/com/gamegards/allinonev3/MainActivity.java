...
//            Toast.makeText(this, ""+message, Toast.LENGTH_SHORT).show();
    ...
    private void InitializeUsers
            (String user_id_player,JSONObject table_users,TextView txtPlay,TextView txtPlaywallet,ImageView imgplcircle)
...
//            txtPlaywallet.setText("" + numberamount);
            txtPlaywallet.setText("" + walletplayer2);

            Picasso.with(MainActivity.this).load(Const.IMGAE_PATH + profile_pic1).into(imgplcircle);
...
//            CreateGroups(bp_cardlist_group4);
    ...
    private void CreateGroups(ArrayList<CardModel> cardImageList,int count) {
        ...
        for (int i = 0; i < cardImageList.size() ; i++) {
            ...
            AddCardtoGroup(cardImageList.get(i).Image,
                    i,
                    lnr_group_card,
                    cardImageList);
...
//                Toast.makeText(MainActivity.this , tag, Toast.LENGTH_LONG).show();
        ...
        if(grouplist_size >= 5)
        {
            valueInPixels = 30 * grouplist_size;
        }
...
//                Toast.makeText(MainActivity.this , tag, Toast.LENGTH_LONG).show();
                ...
                setMargins(view, finalLeft_margin,(int) convertDpToPixel(CardMargin,MainActivity.this)
                        ,(int) convertDpToPixel(right_margin,MainActivity.this), (int) convertDpToPixel(10,MainActivity.this));
...
//        if(countnumber != 0)
//        {
            layoutParams.setMargins(0, (int) convertDpToPixel(15,this), (int) convertDpToPixel(right_margin,this), 0);
//        }
...
//                        }
        ...
        setMargins(view,0,(int) convertDpToPixel(CardMargin,MainActivity.this)
                ,(int) convertDpToPixel(right_margin,MainActivity.this),0);
